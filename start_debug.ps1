# Quiz Master Debug Startup Script for Windows PowerShell

Write-Host "🚀 Starting Quiz Master Application (Debug Mode)..." -ForegroundColor Green
...
try {
    ...
    Write-Host "Backend response: $($healthResponse | ConvertTo-Json)" -ForegroundColor Gray
} catch {
...
Write-Host "🔍 To reset database, run: python reset_db.py" -ForegroundColor Yellow
Write-Host ""
